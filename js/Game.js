class Game {
  ...
  camera.position.y = 0;
   imageMode(CENTER)
    Player.getPlayerInfo();
        image(bronze_image, displayWidth/-4, -100 + displayHeight/9, 200, 240);
         image(silver_image, displayWidth/4, -100 + displayHeight/10, 225, 270);
          image(gold_image, 0, -100, 250, 300); 
          textAlign(CENTER); 
          textSize(50); 
          for(var plr in allPlayers){ 
